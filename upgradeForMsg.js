...
async function main() {
    ...
    // const mintCheckRef = await tryScriptRefUtxo(sdkNew.contracts_msg.OutboundTokenScript.script());
    {
        ...
        newDatum[contractsMgrNew.GroupNFT.InboundCheckVH] = sdkNew.contracts_msg.InboundCheckScript.script().hash().to_hex();
        newDatum[contractsMgrNew.GroupNFT.OutboundHolderVH] = sdkNew.contracts_msg.OutboundHolderScript.script().hash().to_hex();
